...
namespace DatVeXemPhim.Areas.Admin.Controllers
{
    public class CinemasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CinId,NameCi,Address,Seats,Phone,Image,Status")] Cinema cinema)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CinId,NameCi,Address,Seats,Phone,Image,Status")] Cinema cinema)
        {
            if (ModelState.IsValid)
            {
