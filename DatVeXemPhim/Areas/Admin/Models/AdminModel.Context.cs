...
namespace DatVeXemPhim.Areas.Admin.Models
{
    ...
    public partial class BookingTicketEntities1 : DbContext
    {
        public BookingTicketEntities1()
            : base("name=BookingTicketEntities1")
        {
        }
        ...
        public virtual int sp_Slide_Delete(Nullable<int> sliId)
        {
            var sliIdParameter = sliId.HasValue ?
                new ObjectParameter("SliId", sliId) :
                new ObjectParameter("SliId", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_Slide_Delete", sliIdParameter);
        }
    
        public virtual ObjectResult<sp_Slide_GetByAll_Result> sp_Slide_GetByAll()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_Slide_GetByAll_Result>("sp_Slide_GetByAll");
        }
    
        public virtual ObjectResult<sp_Slide_GetById_Result> sp_Slide_GetById(Nullable<int> sliId)
        {
            var sliIdParameter = sliId.HasValue ?
                new ObjectParameter("SliId", sliId) :
                new ObjectParameter("SliId", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_Slide_GetById_Result>("sp_Slide_GetById", sliIdParameter);
        }
    
        public virtual int sp_Slide_GetByTop(string top, string where, string order)
        {
            var topParameter = top != null ?
                new ObjectParameter("Top", top) :
                new ObjectParameter("Top", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_Slide_GetByTop", topParameter, whereParameter, orderParameter);
        }
    
        public virtual int sp_Slide_Insert(Nullable<int> filId, string image, Nullable<int> status)
        {
            var filIdParameter = filId.HasValue ?
                new ObjectParameter("FilId", filId) :
                new ObjectParameter("FilId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_Slide_Insert", filIdParameter, imageParameter, statusParameter);
        }
    
        public virtual int sp_Slide_Update(Nullable<int> sliId, Nullable<int> filId, string image, Nullable<int> status)
        {
            var sliIdParameter = sliId.HasValue ?
                new ObjectParameter("SliId", sliId) :
                new ObjectParameter("SliId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_Slide_Update", sliIdParameter, filIdParameter, imageParameter, statusParameter);
        }
    
        public virtual int sp_Slide_Update_Status(Nullable<int> sliId, Nullable<int> status)
        {
            var sliIdParameter = sliId.HasValue ?
                new ObjectParameter("SliId", sliId) :
                new ObjectParameter("SliId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_Slide_Update_Status", sliIdParameter, statusParameter);
        }
